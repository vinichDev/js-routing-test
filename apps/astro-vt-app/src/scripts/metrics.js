...
export function sendInitialLoadMetricsEvent(params) {
    ...
    const resourceSummary = {
        ...
        total_transfer_size: params.resourceEntries.reduce((sum, e) => sum + (e.transferSize || 0), 0),
        js_transfer_size: jsResources.reduce((sum, e) => sum + (e.transferSize || 0), 0),
        css_transfer_size: cssResources.reduce((sum, e) => sum + (e.transferSize || 0), 0),
    };
